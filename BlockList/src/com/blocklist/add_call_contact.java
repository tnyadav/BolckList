...
public class add_call_contact extends Activity implements OnClickListener {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.add_call_contact);
        context=this;
	...
	public void onClick(View v) {
	    ...
	    case R.id.but_add:
	    	...
	    	{
			    Toast.makeText(add_call_contact.this,"Please Fill Name and Number(10 digits)!!",Toast.LENGTH_LONG).show();
	    	}
	    	else
	    	{
	    	db.open();
	    	db.insertCallContact(edt_contactNo.getText().toString(),edt_contactName.getText().toString());
		    db.close();
		    Toast.makeText(add_call_contact.this,"Contact Added To The Unwanted Call Blacklist!!",Toast.LENGTH_LONG).show();
		    finish();
