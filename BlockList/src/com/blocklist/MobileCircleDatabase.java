...
public class MobileCircleDatabase extends SQLiteOpenHelper {
	...
	private void copydatabase() throws IOException {
        ...
        OutputStream myoutput = new FileOutputStream(
                "/data/data/com.blocklist/databases/" + DATABASE_NAME);
	...
	*/
    ...
    public List<String> getAllCircles()
	{
		...
		Cursor cursor = sqlDatabase.rawQuery("SELECT * FROM " +"circles", null);
    ...
    public List<String> getAllCirclesDesc()
	{
		List<String> contactRecords = new ArrayList<String>();
    ...
    public List<String> getAllOperators()
	{
		...
		Cursor cursor = sqlDatabase.rawQuery("SELECT * FROM " +"operators", null);
    ...
    public List<String> getAllOperatorsDesc()
	{
		List<String> contactRecords = new ArrayList<String>();
