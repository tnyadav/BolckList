...
public class choose_sms_contact extends Activity {
	ListView listView;
	 Intent i;
	String[] values = new String[] {"Choose From Contacts", "Add Manually"};
	    ...
	    public void onCreate(Bundle savedInstanceState) {
	        ...
	        setContentView(R.layout.choose_sms_contact);
	        ...
	        listView.setOnItemClickListener(new OnItemClickListener() {
	          ...
	          public void onItemClick(AdapterView<?> parent, View view,int position, long id) {
	        	  ...
	        	  if(listView.getAdapter().getItem(position).equals("Choose From Contacts"))
	        	  {
	        		 ...
	        		 finish();
	        		i=new Intent(getApplicationContext(),ListDisplayOfSMSContactsActivity.class);
	      			startActivity(i); 
	        	  }
	        	  else
	        	  {
	     	         ...
	     	         //Toast.makeText(getApplicationContext(),listView.getAdapter().getItem(position)+"selected", Toast.LENGTH_LONG).show();
	     	        finish();
	        		i=new Intent(getApplicationContext(),add_sms_contact.class);
	      			startActivity(i); 
	        	  }
	         }
	      });
