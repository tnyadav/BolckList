...
public class ListDisplayOfSMSContactsActivity extends Activity implements OnItemClickListener, OnClickListener 
{
	...
	{    
	    ...
	    case R.id.but_add:
			...
			{  
				...
				contentDataSource.insertSmsContact(contactsDetails.getContactNo(),contactsDetails.getContactName());
			}
			contentDataSource.close();
			Toast.makeText(ListDisplayOfSMSContactsActivity.this,"Contacts Added To The Unwanted SMS Blacklist!!",Toast.LENGTH_LONG).show();
			finish();
